var zoomAggrTreemap = {
	...
	var that = {
	    id:id,
	    ztree: undefined,
	    margin: {top:15, bottom:20, left:20, right:20},
	    ratio: 0.985,
	    // Boostrap library add right and left padding on 15px each
	    w: d3.select(id).node().offsetWidth -30, 
	    h: function(){return this.w*this.ratio;},
	...
	d3.json(url, function(data) {
		...
		.attr('height', that.h())
		.append('svg:g')
	    // Translate 15px because of Boostrap  right and left padding
...
$(document).ready(function(){
    oas = zoomAggrTreemap.generate('json/flare.json','#first');
    blah = zoomAggrTreemap.generate('json/blah.json','#second');
